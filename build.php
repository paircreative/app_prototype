  ...
  <div class="container-fluid" style="padding: 85px;">    
        <nav class="navbar navbar-expand-lg navbar-light bg-light m-3 rounded shadow-sm">
          ...
          <div class="bg-light p-5 m-3 rounded">
                      <div class="row">
                            <div class="col-sm-4">
                                <h2>Build A Portfolio</h2><br />

                                <form class="row g-3"> 
                                  
                                      <div class="col-12">
                                          <nav class="navbar navbar-light bg-light">
                                              <input style="width: 80%;" class="form-control mr-sm-1" type="search" placeholder="Portfolio Name" aria-label="Search">
                                            ...
                                            <table class="table table-striped">
                                                  <tbody>
                                                      <tr>
                                                        ...
                                                        <td width="25%">
                                                              <a class="btn btn-sm btn-dark" href="#" role="button">Shares</a>
                                                              <a class="btn btn-sm btn-dark" href="#" role="button">Add</a>
                                                        </td>
                                                      </tr>
                                                  </tbody>
                                            </table>
                            ...
                            <div class="col-sm-6">
                                ...
                                <table class="table table-fixed">
                                  ...
                                  <div class="col-12" style="text-align: left;">
                                    ...
                                    <button type="submit" class="btn btn-success">Build Portfolio</button>
                                  </div>  
                            </div>
                      </div>
          </div>
